...
if (isset($_POST['cName'])  &&  isset($_POST['cEmail'])  &&  isset($_POST['cCompany'])  &&  isset($_POST['cTelephone'])  &&  isset($_POST['cMessage'])) {
  ...
  echo ("window.location.assign(\"" . get_permalink(get_page_by_title('Home')->ID) . "\")");
  echo ("</script>");
...
<div class="container narrow">
  ...
  <p class="p2title">Contact Us</p>
  <p class="p2subTitle">Keep In Touch</p>
  <form method="post" action="">
    <div class="p2left"><label class="cLabel" for="cName">Your Name</label><br><input class="cInput" type="text" id="cName" name="cName" value="" /></div>
    ...
    <div class="p2right"><label class="cLabel" for="cCompany">Company Name</label><br><input class="cInput" type="text" id="cCompany" name="cCompany" value="" /></div>
    <div class="p2right"><label class="cLabel" for="cTelephone">Telephone</label><br><input class="cInput" type="text" id="cTelephone" name="cTelephone" value="" /></div>
    <div class="container"><label class="cLabel" for="cMessage">Message</label><br><textarea class="cTextArea" name="cMessage" id="cMessage" cols="117" rows="10"></textarea></div>
    <div class="p2center container"><input class="cSubmit" type="submit" value="SEND" id="cSend" name="cSend" /></div>
  </form>

</div>

<div id="cFooter" class="container">
  <p id="cFooterL">5 ha-ofan st.<br>petach tikva</p>
  <p id="cFooterR">tel: +972-3-9267057<br>Email: sales@ra.co.il</p>
</div>

<div id="cMap" class="container">
  <iframe id="googleMap" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src='http://maps.google.com/maps?q=%D7%94%D7%90%D7%95%D7%A4%D7%9F+5+%D7%A4%D7%AA%D7%97+%D7%AA%D7%A7%D7%95%D7%95%D7%94&hl=en&ie=UTF8&ll=32.097409,34.852753&spn=0.157928,0.338173&sll=37.0625,-95.677068&sspn=37.735377,86.572266&hnear=HaOfan+5,+Petah+Tikva,+Israel&t=m&z=12&amp;output=embed'></iframe>
</div>
