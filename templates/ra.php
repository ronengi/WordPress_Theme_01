...
$pageName = str_replace(' ', '_', get_the_title());
...
switch ($pageName) {
case 'Home':         $pageTemplate = E_PAGES    .'eng/'.'Home.php';         break;

case 'Who_Are_We':   $pageTemplate = E_TEMPLATES.'eng/'.'pagra0.php';    break;
case 'About_Us':     $pageTemplate = E_TEMPLATES.'eng/'.'pagra0.php';    break;

case 'Products':     $pageTemplate = E_TEMPLATES.'eng/'.'pagra1.php';    break;
case 'Services':     $pageTemplate = E_TEMPLATES.'eng/'.'pagra1.php';    break;
case 'Solutions':    $pageTemplate = E_TEMPLATES.'eng/'.'pagra1.php';    break;

case 'Contact_Us':   $pageTemplate = E_TEMPLATES.'eng/'.'pagra2.php';    break;


case 'Investigative_and_Regulatory_Organizations':   $pageTemplate = E_TEMPLATES.'eng/'.'pagra3.php';    break;
case 'ra_for_Parliaments':                        $pageTemplate = E_TEMPLATES.'eng/'.'pagra3.php';    break;

case 'Transcription':                                $pageTemplate = E_TEMPLATES.'eng/'.'pagra3.php';    break;
case 'Document_Translation':                         $pageTemplate = E_TEMPLATES.'eng/'.'pagra3.php';    break;
case 'EasySubstitles':                               $pageTemplate = E_TEMPLATES.'eng/'.'pagra3.php';    break;

case 'eParliament':                                  $pageTemplate = E_TEMPLATES.'eng/'.'pagra3.php';    break;
case 'EasyRecord':                                   $pageTemplate = E_TEMPLATES.'eng/'.'pagra3.php';    break;
case 'EasyType':                                     $pageTemplate = E_TEMPLATES.'eng/'.'pagra3.php';    break;
case 'eProtocol':                                    $pageTemplate = E_TEMPLATES.'eng/'.'pagra3.php';    break;
}
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <head>
    ...
    <link rel="stylesheet" href="wp-content/themes/ra/templates/raStyle.css" type="text/css" />
  ...
  <body>
    <a id="_PTOP"></a>
      ...
      <?php
	 require_once(E_MENUS.'eng/'.'header.php');	   /* header menu */
	 require_once($pageTemplate);              /* content */
	 require_once(E_MENUS.'eng/'.'footer_1.php' );	   /* high footer menus */
	 require_once(E_MENUS.'eng/'.'footer_2.php' );	   /* low footer menus */
	 ?>
